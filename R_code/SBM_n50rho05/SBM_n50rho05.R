...
result_n50rho05 <- matrix(0, nrow=8, ncol=4)
...
sim_result7 <- Evaluation_RDPG(SBM_seq10T100n50rho05, M=50, d=5, delta=5)
result_n50rho05[7,] <- colMeans(sim_result7)


sim_result8 <- Evaluation_NBS(SBM_seq10T100n50rho05, M=15, delta=5)
result_n50rho05[8,] <- colMeans(sim_result8)
